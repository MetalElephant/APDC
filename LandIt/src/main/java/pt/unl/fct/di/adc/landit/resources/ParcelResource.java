...
import pt.unl.fct.di.adc.landit.util.ParcelData;
import pt.unl.fct.di.adc.landit.util.ParcelSearchPositionData;
import pt.unl.fct.di.adc.landit.util.ParcelSearchRegionData;
import pt.unl.fct.di.adc.landit.util.ParcelUpdateData;
import pt.unl.fct.di.adc.landit.util.ParcelVerifyData;
...
import pt.unl.fct.di.adc.landit.util.Info.OwnerInfo;
import pt.unl.fct.di.adc.landit.util.Info.ParcelInfo;
