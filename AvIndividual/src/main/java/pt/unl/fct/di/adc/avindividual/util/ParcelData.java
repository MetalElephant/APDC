...
public class ParcelData {
	...
	public boolean isDataValid() {
		...
		if (this.owner == null || this.owners == null || this.parcelName == null || this.county == null || this.district == null || this.freguesia == null ||
			this.description == null || this.groundType == null || this.currUsage == null || this.prevUsage == null || this.area == null || 
			this.allLats == null || this.allLngs == null)
			return false;
		...
		if (this.owner.length() == 0 || this.parcelName.length() == 0 || this.county.length() == 0 || this.district.length() == 0 || this.freguesia.length() == 0 ||
			...
			this.allLats.length == 0 || this.allLngs.length == 0)
			return false;	
