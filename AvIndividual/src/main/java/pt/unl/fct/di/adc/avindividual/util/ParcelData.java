...
public class ParcelData {
	...
	public ParcelData(String owner, String[] owners, String parcelName, String parcelRegion, String description, String groundType, String currUsage,
					  String prevUsage, String area, double[] allLats, double[] allLngs) {
		this.owner = owner;
		this.owners = owners;
	...
	public boolean isDataValid() {
		...
		if (this.owner.length() == 0 || this.parcelName.length() == 0 || this.parcelRegion.length() == 0 || this.description.length() == 0 ||
		    this.groundType.length() == 0 || this.currUsage.length() == 0 || this.prevUsage.length() == 0 || this.area.length() == 0 || this.allLats.length == 0 || this.allLngs.length == 0)
			return false;	
