...
public class ComputationResource {
	...
	/**
	 * Creates a background task in the default queue of the app engine - for long, time-consuming tasks
	 */
	@GET
	@Path("/compute")
	...
	/**
	 * The background task itself - in this case 5 min sleep
	 * Codified with POST, executed through the GET above
	 */
	@POST
	@Path("/compute")
