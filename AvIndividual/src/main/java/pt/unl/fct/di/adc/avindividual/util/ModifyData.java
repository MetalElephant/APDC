...
public class ModifyData {
	...
	public ModifyData(String username, String username2, String name,  String email, String profile, String landPhone,
	...
	public boolean canUpdateValues(String user_role,String user2_role) {
		...
		if (user_role.equals("USER")) { 
			if(username.equals(username2) && this.name == null && this.email == null && this.role == null)
				return true;			
		}
